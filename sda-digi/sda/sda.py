...
# this is not used by the generator!
def get_audio_feature_extractor(model_path="grid", gpu=-1):
    ...
    # build the RNN for audio and put it on the GPU
...
class VideoAnimator():
    def __init__(self, model_path="grid", gpu=-1):
        ...
        # probably references for skip connections
    ...
    def __call__(self, img, audio, fs=None, aligned=False):
        ...
        print(gen_video.shape)
        print("rnn shape :", z.shape)
        print("rnn input shape :", audio_feat_seq.shape)
